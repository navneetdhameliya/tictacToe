...
FirebaseImageProvider imageName = images("gs://tictactoe-a0520.appspot.com/bgColor.png");
String ImageX = player0Path;
String ImageY = player1Path;
bool test = false;

class Player {
  static FirebaseImageProvider none = imageName;
  static FirebaseImageProvider X = images(ImageX);
  static FirebaseImageProvider O = images(ImageY);
  static FirebaseImageProvider pressed = imageName;

  static String cardColorP1 = player1BgPath;
  static String cardColorP2 = player2BgPath;
  static List<List<FirebaseImageProvider>> matrix = List.generate(3, (i) => List.filled(3, imageName));
  static List<List<Color>> cardColors = List.generate(3, (i) => List.filled(3, kContainerCardColor));

  static  FirebaseImageProvider p1 = images(ImageX);
  static  FirebaseImageProvider p2 = images(ImageY);
  static int count = 0;
  ...
  static FirebaseImageProvider side = imageName;
  static List<int> li = [];
  ...
  static void updateToEmptyMatrix() {
    ...
    cardColors = List.generate(3, (i) => List.filled(3, kTextColor));
  }
  ...
  String player1BgChange() {
    return cardColorP1 = player1 ? player1BgPath : player2BgPath ;
  }

  String player2BgChange(){
    return cardColorP2 = player1 ? player2BgPath : player1BgPath   ;
  }

  void changeWinnerCardColor() {
    if (p1 == side) {
      cardColorP1 = player1BgPath;
    } else if (p2 == side) {
      cardColorP2 = player2BgPath;
    }
  }
...
FirebaseImageProvider images(String imagePath){
